    ...
    var i = n(4),
        ...
        h = function(e, t, n) {
            ...
            b.initialize = function() {
                b.logError = o.withModule(s), b.establishPreconnections(), b.collectWidgets(t), b.revise(), i(function() {
                ...
                if (n.forEach(function(e) {
                    ...
                    o.open("get", a + "?" + s), o.withCredentials = !0, o.onload = function() {
                        var t = JSON.parse(o.response);
                        t.status || b.logError("Boot failed because " + t.reason, t.data), v = Object.assign({}, v, t.data.widgets), b.loadAssets(t.data.assets), m.forEach(b.initWidget.bind(b)), x = x.filter(function(e) {
                            return !i.includes(e)
                        }), e && e()
                    }, o.send()
                }
                ...
                t && t.length && t.filter(function(e) {
                    ...
                    n.src = t, n.async = !0, n.charset = "UTF-8", e.document.head.appendChild(n), y.push(t)
                })
            }, b.observe = function() {
        ...
        i = function(e) {
            ...
            t.initialize = function() {
                ...
                if (i) {
                    ...
                    e.initWidget(n, l, o), o.isOwner && setTimeout(function() {
                        t.initToolbar(n, o)
                    }, 500)
                } else r.push({
                    element: n,
